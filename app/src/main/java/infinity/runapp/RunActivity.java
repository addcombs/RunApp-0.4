...
public class RunActivity extends ActionBarActivity implements
    ...
    protected static final String TAG = "Run";
    ...
    protected Chronometer mStopwatch;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStopwatch = (Chronometer) findViewById(R.id.stopwatch);
    ...
    private void updateUI() {
        if (mCurrentLocation != null) {
            mDistanceTextView.setText(String.valueOf(totalDistance));
...
//            googleMap.addMarker(marker);
            ...
            polylineOptions.color(R.color.piGreen);
    ...
    public void goSummary(){
        ...
        info.putString("data", "summary");
        info.putLong("time", elapsedMillis);
        info.putFloat("distance", totalDistance);

        Intent summary = new Intent(this, MainActivity.class);
        summary.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        summary.putExtras(info);
